<script>
	...
	function act_createXLS(){
		$.post( site_url + 'report/get_product_ticket',{export:'xls', start:$('#start').val(), end:$('#end').val(), search:$('#search').val(), status : $('#status').val()}, function(data){
			if(data.status){
...
<section id="page-rep-ticket-product">
	<div class="mail-containers">
		<div class="mail-container-header">
			Laporan Berdasarkan Produk <loading></loading>
        ...
        <div class="row" id="grid-body">
			<div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6" id="sidebar-report">
