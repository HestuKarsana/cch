<script>
	...
	function act_createXLS(){
		$.post( site_url + 'report/get_outgoing_kprk_ticket',{export:'xls', kprk:getUri(site_url, 3), start:$('#start').val(), end:$('#end').val(), search:$('#search').val(), filter : $('#status').val()}, function(data){
			if(data.status){
...
<section id="page-rep-ticket-outgoing-kprk">
	<div class="mail-containers">
		<div class="mail-container-header">
			Laporan Tiket Keluar - <?php echo $kprk->fullname;?><loading></loading>
