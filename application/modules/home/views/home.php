							...
							<li class="nav-icon-btn nav-icon-btn-success dropdown">
								...
								<div class="dropdown-menu widget-messages-alt no-padding" style="width: 300px;">
									<div class="messages-list" id="main-navbar-messages">
										...
										<div class="message">
											<img src="<?php echo base_url('assets/demo/avatars/2.jpg');?>" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="<?php echo base_url('assets/demo/avatars/3.jpg');?>" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="<?php echo base_url('assets/demo/avatars/4.jpg');?>" alt="" class="message-avatar">
										...
										<div class="message">
											<img src="<?php echo base_url('assets/demo/avatars/5.jpg');?>" alt="" class="message-avatar">
											<a href="#" class="message-subject">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
											<div class="message-description">
...
<!-- /3. $END_NAVBAR_ICON_BUTTONS -->
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle user-menu" data-toggle="dropdown">
									<img src="<?php echo base_url('assets/demo/avatars/1.jpg');?>" alt="">
									<span>John Doe</span>
								</a>
								<ul class="dropdown-menu">
		...
		<div id="main-menu-inner">
			<div class="menu-content top" id="menu-content-demo">
				...
				<div>
					...
					<img src="<?php echo base_url('assets/demo/avatars/1.jpg');?>" alt="" class="">
					<div class="btn-group">
