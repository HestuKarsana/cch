<script>
	...
	function act_createXLS(){
		$.post( site_url + 'report/get_incoming_ticket',{export:'xls', start:$('#start').val(), end:$('#end').val(), search:$('#search').val(), status : $('#status').val()}, function(data){
			if(data.status){
...
<section id="page-rep-ticket-incoming">
	<div class="mail-containers">
		<div class="mail-container-header">
			Laporan Tiket Masuk <loading></loading>
