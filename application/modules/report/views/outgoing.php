<script>
	...
	function act_createXLS(){
		$.post( site_url + 'report/get_outgoing_ticket',{export:'xls', start:$('#start').val(), end:$('#end').val(), search:$('#search').val(), status : $('#status').val()}, function(data){
			if(data.status){
...
<section id="page-rep-ticket-outgoing">
	<div class="mail-containers">
		<div class="mail-container-header">
			Laporan Tiket Keluar <loading></loading>
