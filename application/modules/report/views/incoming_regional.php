<script>
	...
	function act_createXLS(){
		$.post( site_url + 'report/get_incoming_regional_ticket',{export:'xls', regid:getUri(site_url, 3), start:$('#start').val(), end:$('#end').val(), search:$('#search').val(), status : $('#status').val()}, function(data){
			if(data.status){
...
<section id="page-rep-ticket-incoming-regional">
	<div class="mail-containers">
		<div class="mail-container-header">
			Laporan Tiket Masuk - <?php echo $reg->regional.' '.$reg->city.' '.$status;?><loading></loading>
