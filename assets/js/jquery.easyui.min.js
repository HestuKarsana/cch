...
t.fitted=true;
p.fcount=_25+1;
$(p).addClass("easypanel-noscroll");
if(p.tagName=="BODY"){
$("html").addClass("easypanel-fit");
}
}
...
p.fcount=_25-1;
if(p.fcount==0){
$(p).removeClass("easypanel-noscroll");
if(p.tagName=="BODY"){
$("html").removeClass("easypanel-fit");
}
}
}
return false;
...
var _214=$.data(_212,"easypanel");
var opts=_214.options;
var _215=_214.easypanel;
var _216=_215.children(".easypanel-header");
var _217=_215.children(".easypanel-body");
var _218=_215.children(".easypanel-footer");
if(_213){
...
$(_212).easypanel("doLayout");
};
function _21a(_21b,_21c){
var _21d=$.data(_21b,"easypanel");
var opts=_21d.options;
var _21e=_21d.easypanel;
if(_21c){
if(_21c.left!=null){
opts.left=_21c.left;
}
...
function _21f(_220){
$(_220).addClass("easypanel-body")._size("clear");
var _221=$("<div class=\"easypanel\"></div>").insertBefore(_220);
...
function _223(_224){
var _225=$.data(_224,"easypanel");
var opts=_225.options;
var _226=_225.easypanel;
_226.css(opts.style);
_226.addClass(opts.cls);
_227();
_228();
var _229=$(_224).easypanel("header");
var body=$(_224).easypanel("body");
var _22a=$(_224).siblings(".easypanel-footer");
if(opts.border){
_229.removeClass("easypanel-header-noborder");
body.removeClass("easypanel-body-noborder");
_22a.removeClass("easypanel-footer-noborder");
}else{
_229.addClass("easypanel-header-noborder");
body.addClass("easypanel-body-noborder");
_22a.addClass("easypanel-footer-noborder");
}
_229.addClass(opts.headerCls);
body.addClass(opts.bodyCls);
$(_224).attr("id",opts.id||"");
if(opts.content){
$(_224).easypanel("clear");
$(_224).html(opts.content);
$.parser.parse($(_224));
}
function _227(){
if(opts.noheader||(!opts.title&&!opts.header)){
_210(_226.children(".easypanel-header"));
_226.children(".easypanel-body").addClass("easypanel-body-noheader");
}else{
if(opts.header){
$(opts.header).addClass("easypanel-header").prependTo(_226);
}else{
var _22b=_226.children(".easypanel-header");
if(!_22b.length){
_22b=$("<div class=\"easypanel-header\"></div>").prependTo(_226);
}
if(!$.isArray(opts.tools)){
_22b.find("div.easypanel-tool .easypanel-tool-a").appendTo(opts.tools);
}
_22b.empty();
var _22c=$("<div class=\"easypanel-title\"></div>").html(opts.title).appendTo(_22b);
if(opts.iconCls){
_22c.addClass("easypanel-with-icon");
$("<div class=\"easypanel-icon\"></div>").addClass(opts.iconCls).appendTo(_22b);
}
var tool=$("<div class=\"easypanel-tool\"></div>").appendTo(_22b);
...
$(this).addClass($(this).attr("iconCls")).addClass("easypanel-tool-a").appendTo(tool);
});
}
}
if(opts.collapsible){
_22d(tool,"easypanel-tool-collapse",function(){
...
if(opts.minimizable){
_22d(tool,"easypanel-tool-min",function(){
_252(_224);
});
}
if(opts.maximizable){
_22d(tool,"easypanel-tool-max",function(){
...
if(opts.closable){
_22d(tool,"easypanel-tool-close",function(){
_23f(_224);
});
}
}
_226.children("div.easypanel-body").removeClass("easypanel-body-noheader");
}
};
...
function _228(){
if(opts.footer){
$(opts.footer).addClass("easypanel-footer").appendTo(_226);
$(_224).addClass("easypanel-body-nobottom");
}else{
_226.children(".easypanel-footer").remove();
$(_224).removeClass("easypanel-body-nobottom");
}
};
};
function _22f(_230,_231){
var _232=$.data(_230,"easypanel");
...
$(_230).easypanel("clear");
$(_230).html($("<div class=\"easypanel-loading\"></div>").html(opts.loadingMessage));
}
...
function _237(_238){
$(_238).easypanel("doLayout",true);
};
function _239(_23a,_23b){
var opts=$.data(_23a,"easypanel").options;
var _23c=$.data(_23a,"easypanel").easypanel;
if(_23b!=true){
...
var tool=_23c.children(".easypanel-header").find("a.easypanel-tool-restore");
if(tool.length){
opts.maximized=true;
}
...
var _242=$.data(_240,"easypanel");
var opts=_242.options;
var _243=_242.easypanel;
if(_241!=true){
...
var _247=$.data(_245,"easypanel");
var opts=_247.options;
var _248=_247.easypanel;
if(_246!=true){
if(opts.onBeforeDestroy.call(_245)==false){
return;
}
}
$(_245).easypanel("clear").easypanel("clear","footer");
_210(_248);
opts.onDestroy.call(_245);
};
function _23e(_249,_24a){
var opts=$.data(_249,"easypanel").options;
var _24b=$.data(_249,"easypanel").easypanel;
var body=_24b.children(".easypanel-body");
var tool=_24b.children(".easypanel-header").find("a.easypanel-tool-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
tool.addClass("easypanel-tool-expand");
if(_24a==true){
...
var opts=$.data(_24d,"easypanel").options;
var _24f=$.data(_24d,"easypanel").easypanel;
var body=_24f.children(".easypanel-body");
var tool=_24f.children(".easypanel-header").find("a.easypanel-tool-collapse");
...
tool.removeClass("easypanel-tool-expand");
if(_24e==true){
...
function _23d(_250){
var opts=$.data(_250,"easypanel").options;
var _251=$.data(_250,"easypanel").easypanel;
var tool=_251.children(".easypanel-header").find("a.easypanel-tool-max");
if(opts.maximized==true){
return;
}
tool.addClass("easypanel-tool-restore");
if(!$.data(_250,"easypanel").original){
$.data(_250,"easypanel").original={width:opts.width,height:opts.height,left:opts.left,top:opts.top,fit:opts.fit};
}
opts.left=0;
opts.top=0;
opts.fit=true;
...
function _252(_253){
var opts=$.data(_253,"easypanel").options;
var _254=$.data(_253,"easypanel").easypanel;
_254._size("unfit");
_254.hide();
opts.minimized=true;
opts.maximized=false;
...
function _255(_256){
var opts=$.data(_256,"easypanel").options;
var _257=$.data(_256,"easypanel").easypanel;
var tool=_257.children(".easypanel-header").find("a.easypanel-tool-max");
if(opts.maximized==false){
return;
}
_257.show();
tool.removeClass("easypanel-tool-restore");
$.extend(opts,$.data(_256,"easypanel").original);
_211(_256);
opts.minimized=false;
opts.maximized=false;
$.data(_256,"easypanel").original=null;
opts.onRestore.call(_256);
};
function _258(_259,_25a){
$.data(_259,"easypanel").options.title=_25a;
$(_259).easypanel("header").find("div.easypanel-title").html(_25a);
};
var _25b=null;
$(window).unbind(".easypanel").bind("resize.easypanel",function(){
if(_25b){
clearTimeout(_25b);
}
...
$("body").easypanel("doLayout");
}
_25b=null;
},100);
});
$.fn.easypanel=function(_25d,_25e){
if(typeof _25d=="string"){
return $.fn.easypanel.methods[_25d](this,_25e);
}
_25d=_25d||{};
return this.each(function(){
var _25f=$.data(this,"easypanel");
var opts;
if(_25f){
opts=$.extend(_25f.options,_25d);
_25f.isLoaded=false;
}else{
opts=$.extend({},$.fn.easypanel.defaults,$.fn.easypanel.parseOptions(this),_25d);
$(this).attr("title","");
_25f=$.data(this,"easypanel",{options:opts,easypanel:_21f(this),isLoaded:false});
}
_223(this);
$(this).show();
if(opts.doSize==true){
_25f.easypanel.css("display","block");
_211(this);
}
...
$.fn.easypanel.methods={options:function(jq){
return $.data(jq[0],"easypanel").options;
},easypanel:function(jq){
return $.data(jq[0],"easypanel").easypanel;
},header:function(jq){
return $.data(jq[0],"easypanel").easypanel.children(".easypanel-header");
},footer:function(jq){
return jq.easypanel("easypanel").children(".easypanel-footer");
},body:function(jq){
return $.data(jq[0],"easypanel").easypanel.children(".easypanel-body");
...
return jq.each(function(){
_235(type=="footer"?$(this).easypanel("footer"):this);
});
},refresh:function(jq,href){
return jq.each(function(){
var _264=$.data(this,"easypanel");
_264.isLoaded=false;
if(href){
...
return jq.each(function(){
_266(this,"body");
_266($(this).siblings(".easypanel-footer")[0],"footer");
function _266(_267,type){
if(!_267){
return;
}
var _268=_267==$("body")[0];
var s=$(_267).find("div.easypanel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.easyui-fluid:visible").filter(function(_269,el){
var p=$(el).parents(".easypanel-"+type+":first");
...
$.fn.easypanel.parseOptions=function(_26d){
var t=$(_26d);
var hh=t.children(".easypanel-header,header");
var ff=t.children(".easypanel-footer,footer");
return $.extend({},$.parser.parseOptions(_26d,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","tools","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("easypanel-header"):undefined),footer:(ff.length?ff.removeClass("easypanel-footer"):undefined)});
};
$.fn.easypanel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,openAnimation:false,openDuration:400,closeAnimation:false,closeDuration:400,tools:null,footer:null,header:null,queryParams:{},method:"get",href:null,loadingMessage:"Loading...",loader:function(_26e,_26f,_270){
var opts=$(this).easypanel("options");
if(!opts.href){
return false;
}
...
$(_277).easypanel("move",_279.options);
if(_279.shadow){
...
var win=$(_285).easypanel($.extend({},_286.options,{border:false,doSize:true,closed:true,cls:"window "+(!opts.border?"window-thinborder window-noborder ":(opts.border=="thin"?"window-thinborder ":""))+(opts.cls||""),headerCls:"window-header "+(opts.headerCls||""),bodyCls:"window-body "+(opts.noheader?"window-body-noheader ":" ")+(opts.bodyCls||""),onBeforeDestroy:function(){
...
var _289=$(this).easypanel("options");
...
_286.window=win.easypanel("easypanel");
if(_286.mask){
_286.mask.remove();
}
if(opts.modal){
...
_293.window.draggable({handle:">div.easypanel-header>div.easypanel-title",disabled:_293.options.draggable==false,onBeforeDrag:function(e){
if(_293.mask){
...
return this.easypanel(_297,_298);
}
}
_297=_297||{};
return this.each(function(){
...
return $.extend({},$.fn.easypanel.parseOptions(_2a0),$.parser.parseOptions(_2a0,[{draggable:"boolean",resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
$.fn.window.defaults=$.extend({},$.fn.easypanel.defaults,{zIndex:9000,draggable:true,resizable:true,shadow:true,modal:false,border:true,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false,constrain:false});
})(jQuery);
(function($){
function _2a1(_2a2){
...
var _2cd=0;
var _2ce="auto";
var _2cf=cc.find(">.easypanel>.accordion-header");
if(_2cf.length){
...
var p=_2cc[i];
var h=p.easypanel("header")._outerHeight(_2cd);
if(p.easypanel("options").collapsible==_2d1){
var _2d4=isNaN(_2d2)?undefined:(_2d2+_2cd*h.length);
p.easypanel("resize",{width:cc.width(),height:(_2d1?_2d4:undefined)});
_2d3+=p.easypanel("easypanel").outerHeight()-_2cd*h.length;
}
}
return _2d3;
};
...
var _2d9=$.data(_2d6,"accordion").easypanels;
var pp=[];
for(var i=0;i<_2d9.length;i++){
var p=_2d9[i];
if(_2d7){
if(p.easypanel("options")[_2d7]==_2d8){
pp.push(p);
}
}else{
if(p[0]==$(_2d8)[0]){
...
var _2e4=$.data(_2e2,"accordion").easypanels;
...
pp.easypanel($.extend({},{collapsible:true,minimizable:false,maximizable:false,closable:false,doSize:false,collapsed:true,headerCls:"accordion-header",bodyCls:"accordion-body"},_2ec,{onBeforeExpand:function(){
...
return p.easypanel("options").collapsible;
});
for(var i=0;i<all.length;i++){
_2f4(_2eb,_2de(_2eb,all[i]));
}
}
var _2ed=$(this).easypanel("header");
...
opts.onSelect.call(_2eb,$(this).easypanel("options").title,_2de(_2eb,this));
},onBeforeCollapse:function(){
...
var _2ee=$(this).easypanel("header");
...
opts.onUnselect.call(_2eb,$(this).easypanel("options").title,_2de(_2eb,this));
}}));
var _2ef=pp.easypanel("header");
var tool=_2ef.children("div.easypanel-tool");
tool.children("a.easypanel-tool-collapse").hide();
var t=$("<a href=\"javascript:void(0)\"></a>").addClass("accordion-collapse accordion-expand").appendTo(tool);
t.bind("click",function(){
_2f0(pp);
return false;
});
pp.easypanel("options").collapsible?t.show():t.hide();
_2ef.click(function(){
_2f0(pp);
return false;
});
function _2f0(p){
var _2f1=p.easypanel("options");
if(_2f1.collapsible){
...
p.easypanel("expand",opts.animate);
};
...
p.easypanel("collapse",opts.animate);
};
function _2fa(_2fb){
...
function _2f7(_2ff){
var _300=$.data(_2ff,"accordion").easypanels;
...
var _309=_308.easypanels;
_2f7(_306);
var _30a=_2e1(_306,_307);
var _30b=_30a.easypanel("options").title;
...
$.data(this,"accordion",{options:$.extend({},$.fn.accordion.defaults,$.fn.accordion.parseOptions(this),_30d),accordion:$(this).addClass("accordion"),easypanels:[]});
init(this);
}
_2e5(this);
_2c8(this);
...
},easypanels:function(jq){
return $.data(jq[0],"accordion").easypanels;
...
return _2dc(jq[0]);
},geteasypanel:function(jq,_311){
return _2e1(jq[0],_311);
},geteasypanelIndex:function(jq,_312){
...
var _334=cc.children("div.tabs-easypanels");
...
cc.children("div.tabs-easypanels").children("div").each(function(i){
...
if(li.length){
var _349=_348(li);
var _34a=_347.tabs[_349].easypanel("options");
if(_34a.collapsible){
...
var _34f=$(_34d).children("div.tabs-easypanels");
_34e.removeClass("tabs-header-top tabs-header-bottom tabs-header-left tabs-header-right");
_34f.removeClass("tabs-easypanels-top tabs-easypanels-bottom tabs-easypanels-left tabs-easypanels-right");
...
_34f.addClass("tabs-easypanels-top");
}else{
if(opts.tabPosition=="left"){
_34e.addClass("tabs-header-left");
_34f.addClass("tabs-easypanels-right");
}else{
if(opts.tabPosition=="right"){
_34e.addClass("tabs-header-right");
_34f.addClass("tabs-easypanels-left");
}
}
}
}
...
_34f.removeClass("tabs-easypanels-noborder");
}else{
_34e.addClass("tabs-header-noborder");
_34f.addClass("tabs-easypanels-noborder");
}
opts.doSize=true;
};
...
var _354=$(_351).children("div.tabs-easypanels");
...
pp.insertBefore(_354.children("div.easypanel:eq("+_352.index+")"));
tabs.splice(_352.index,0,pp);
}
pp.easypanel($.extend({},_352,{tab:tab,border:false,noheader:true,closed:true,doSize:false,iconCls:(_352.icon?_352.icon:undefined),onLoad:function(){
if(_352.onLoad){
...
var _355=$(this).easypanel("options");
...
var _358=$(this).easypanel("easypanel");
...
var _359=$(this).easypanel("options");
...
$(this).easypanel("options").tab.removeClass("tabs-selected");
},onClose:function(){
if(_352.onClose){
_352.onClose.call(this);
}
var _35a=$(this).easypanel("options");
_353.options.onUnselect.call(_351,_35a.title,_35b(_351,this));
}}));
$(_351).tabs("update",{tab:pp,options:pp.easypanel("options"),type:"header"});
};
...
var p=tabs[i];
tmp.html(p.easypanel("options").title);
if(tmp.text()==_373){
tab=p;
if(_374){
tabs.splice(i,1);
...
for(var i=0;i<tabs.length;i++){
var tab=tabs[i];
if(tab.easypanel("options").tab.hasClass("tabs-selected")){
return tab;
}
}
return null;
...
var tabs=_379.tabs;
for(var i=0;i<tabs.length;i++){
var opts=tabs[i].easypanel("options");
...
if(p&&!p.is(":visible")){
_37c(_37a);
if(!p.easypanel("options").disabled){
p.easypanel("open");
}
}
};
...
function _37c(_380){
$(_380).children("div.tabs-easypanels").each(function(){
$(this).stop(true,true);
});
};
...
return jq.each(function(){
var opts=$(this).tabs("getTab",_394).easypanel("options");
opts.tab.removeClass("tabs-disabled");
opts.disabled=false;
});
},disableTab:function(jq,_395){
return jq.each(function(){
var opts=$(this).tabs("getTab",_395).easypanel("options");
opts.tab.addClass("tabs-disabled");
opts.disabled=true;
});
...
_3ad.center.easypanel("resize",cpos);
function _3ae(pp,type){
if(!pp.length||!_3af(pp)){
return;
}
var opts=pp.easypanel("options");
pp.easypanel("resize",{width:cc.width(),height:opts.height});
var _3b1=pp.easypanel("easypanel").outerHeight();
pp.easypanel("move",{left:0,top:(type=="n"?0:cc.height()-_3b1)});
cpos.height-=_3b1;
if(type=="n"){
cpos.top+=_3b1;
...
var opts=pp.easypanel("options");
pp.easypanel("resize",{width:opts.width,height:cpos.height});
var _3b2=pp.easypanel("easypanel").outerWidth();
pp.easypanel("move",{left:(type=="e"?cc.width()-_3b2:0),top:cpos.top});
cpos.width-=_3b2;
if(type=="w"){
cpos.left+=_3b2;
if(!opts.split&&opts.border){
...
cc.addClass("layout");
function _3b4(el){
var _3b5=$.fn.layout.parseeasypanelOptions(el);
...
var _3bb=$.data(_3b9,"layout").easypanels;
var cc=$(_3b9);
var dir=_3ba.region;
if(_3bb[dir].length){
return;
...
var _3bc=$.extend({},$.fn.layout.easypaneldefaults,{width:(pp.length?parseInt(pp[0].style.width)||pp.outerWidth():"auto"),height:(pp.length?parseInt(pp[0].style.height)||pp.outerHeight():"auto"),doSize:false,collapsible:true,onOpen:function(){
var tool=$(this).easypanel("header").children("div.easypanel-tool");
tool.children("a.easypanel-tool-collapse").hide();
...
$(this).easypanel("options").collapsible?t.show():t.hide();
}},_3ba,{cls:((_3ba.cls||"")+" layout-easypanel layout-easypanel-"+dir),bodyCls:((_3ba.bodyCls||"")+" layout-body")});
pp.easypanel(_3bc);
_3bb[dir]=pp;
var _3bf={north:"s",south:"n",east:"w",west:"e"};
var _3c0=pp.easypanel("easypanel");
if(pp.easypanel("options").split){
_3c0.addClass("layout-split-"+dir);
}
_3c0.resizable($.extend({},{handles:(_3bf[dir]||""),disabled:(!pp.easypanel("options").split),onStartResize:function(e){
_3a8=true;
...
var _3c8=$.data(_3c6,"layout").easypanels;
if(_3c8[_3c7].length){
_3c8[_3c7].easypanel("destroy");
_3c8[_3c7]=$();
var _3c9="expand"+_3c7.substring(0,1).toUpperCase()+_3c7.substring(1);
if(_3c8[_3c9]){
_3c8[_3c9].easypanel("destroy");
_3c8[_3c9]=undefined;
}
...
var _3ce=$.data(_3cb,"layout").easypanels;
var p=_3ce[_3cc];
var _3cf=p.easypanel("options");
...
if(!_3ce[_3d0]){
_3ce[_3d0]=_3d1(_3cc);
var ep=_3ce[_3d0].easypanel("easypanel");
if(!_3cf.expandMode){
...
p.easypanel("expand",false).easypanel("open");
var _3d2=_3d3();
p.easypanel("resize",_3d2.collapse);
p.easypanel("easypanel").animate(_3d2.expand,function(){
$(this).unbind(".layout").bind("mouseleave.layout",{region:_3cc},function(e){
if(_3a8==true){
return;
}
if($("body>div.combo-p>div.combo-easypanel:visible").length){
return;
}
...
var _3d4=_3d3();
if(!_3af(_3ce[_3d0])){
_3ce.center.easypanel("resize",_3d4.resizeC);
}
p.easypanel("easypanel").animate(_3d4.collapse,_3cd,function(){
p.easypanel("collapse",false).easypanel("close");
_3ce[_3d0].easypanel("open").easypanel("resize",_3d4.expandP);
$(this).unbind(".layout");
...
isns?p.easypanel("setTitle",_3d6):p.html(_3d6);
}
p.easypanel("easypanel").hover(function(){
...
function _3d3(){
var cc=$(_3cb);
var _3d7=_3ce.center.easypanel("options");
var _3d8=_3cf.collapsedSize;
if(_3cc=="east"){
var _3d9=p.easypanel("easypanel")._outerWidth();
...
if(_3cc=="north"){
var _3db=p.easypanel("easypanel")._outerHeight();
var hh=_3d7.height;
if(!_3af(_3ce.expandNorth)){
hh+=_3db-_3d8+((_3cf.split||!_3cf.border)?1:0);
}
_3ce.east.add(_3ce.west).add(_3ce.expandEast).add(_3ce.expandWest).easypanel("resize",{top:_3d8-1,height:hh});
...
_3ce.east.add(_3ce.west).add(_3ce.expandEast).add(_3ce.expandWest).easypanel("resize",{height:hh});
...
var _3df=$.data(_3dd,"layout").easypanels;
var p=_3df[_3de];
var _3e0=p.easypanel("options");
if(_3e0.onBeforeExpand.call(p)==false){
return;
}
var _3e1="expand"+_3de.substring(0,1).toUpperCase()+_3de.substring(1);
if(_3df[_3e1]){
_3df[_3e1].easypanel("close");
p.easypanel("easypanel").stop(true,true);
p.easypanel("expand",false).easypanel("open");
var _3e2=_3e3();
p.easypanel("resize",_3e2.collapse);
p.easypanel("easypanel").animate(_3e2.expand,function(){
_3a9(_3dd);
...
function _3e3(){
var cc=$(_3dd);
var _3e4=_3df.center.easypanel("options");
if(_3de=="east"&&_3df.expandEast){
return {collapse:{left:cc.width(),top:_3e4.top,height:_3e4.height},expand:{left:cc.width()-p.easypanel("easypanel")._outerWidth()}};
}else{
if(_3de=="west"&&_3df.expandWest){
return {collapse:{left:-p.easypanel("easypanel")._outerWidth(),top:_3e4.top,height:_3e4.height},expand:{left:0}};
}else{
if(_3de=="north"&&_3df.expandNorth){
return {collapse:{top:-p.easypanel("easypanel")._outerHeight(),width:cc.width()},expand:{top:0}};
}else{
if(_3de=="south"&&_3df.expandSouth){
return {collapse:{top:cc.height(),width:cc.width()},expand:{top:cc.height()-p.easypanel("easypanel")._outerHeight()}};
}
}
}
}
...
if(pp.length){
return pp.easypanel("easypanel").is(":visible");
}else{
return false;
}
};
...
function _3ea(_3eb){
var p=_3e8[_3eb];
if(p.length&&p.easypanel("options").collapsed){
_3ca(_3e6,_3eb,0);
}
};
};
function _3ec(_3ed,_3ee,_3ef){
var p=$(_3ed).layout("easypanel",_3ee);
p.easypanel("options").split=_3ef;
var cls="layout-split-"+_3ee;
var _3f0=p.easypanel("easypanel").removeClass(cls);
if(_3ef){
_3f0.addClass(cls);
}
...
$.data(this,"layout",{options:opts,easypanels:{center:$(),north:$(),south:$(),east:$(),west:$()}});
init(this);
}
_3a9(this);
_3e5(this);
...
},easypanel:function(jq,_3f5){
return $.data(jq[0],"layout").easypanels[_3f5];
...
_3b8(this,_3f8);
_3a9(this);
if($(this).layout("easypanel",_3f8.region).easypanel("options").collapsed){
...
$.fn.layout.parseeasypanelOptions=function(_401){
var t=$(_401);
return $.extend({},$.fn.easypanel.parseOptions(_401),$.parser.parseOptions(_401,["region",{split:"boolean",collpasedSize:"number",minWidth:"number",minHeight:"number",maxWidth:"number",maxHeight:"number"}]));
};
$.fn.layout.easypaneldefaults=$.extend({},$.fn.easypanel.defaults,{region:null,split:false,collapsedSize:28,expandMode:"float",hideExpandTool:false,hideCollapsedContent:true,collapsedContent:function(_402){
var p=$(this);
var opts=p.easypanel("options");
...
var cc=[];
if(opts.iconCls){
cc.push("<div class=\"easypanel-icon "+opts.iconCls+"\"></div>");
}
cc.push("<div class=\"easypanel-title layout-expand-title");
...
var _647=_646.easypanel;
if(_645){
$.extend(opts,_645);
}
if(opts.fit==true){
var p=_647.easypanel("easypanel").parent();
opts.width=p.width();
opts.height=p.height();
}
_647.easypanel("resize",opts);
};
function _648(_649){
var _64a=$.data(_649,"datagrid");
var opts=_64a.options;
var dc=_64a.dc;
var wrap=_64a.easypanel;
var _64b=wrap.width();
...
_673.easypanel({doSize:false,cls:"datagrid"});
...
$.data(this,"datagrid",{options:opts,easypanel:_7b5.easypanel,dc:_7b5.dc,ss:null,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_676(this);
_68d(this);
_643(this);
...
var _7de=$.data(jq[0],"datagrid").easypanel.easypanel("options");
...
return _634(jq[0]);
},geteasypanel:function(jq){
return $.data(jq[0],"datagrid").easypanel;
},getPager:function(jq){
return $.data(jq[0],"datagrid").easypanel.children("div.datagrid-pager");
...
if(opts.loadMsg){
var _7e6=$(this).datagrid("geteasypanel");
...
var _7e7=$(this).datagrid("geteasypanel");
...
if(col.hidden){
col.hidden=false;
$(this).datagrid("geteasypanel").find("td[field=\""+_805+"\"]").show();
_6ca(this,_805,1);
...
if(!col.hidden){
col.hidden=true;
$(this).datagrid("geteasypanel").find("td[field=\""+_806+"\"]").hide();
_6ca(this,_806,-1);
$(this).datagrid("fitColumns");
}
});
...
if(opts.showFooter){
var _84b=$(_849).datagrid("geteasypanel").find("div.datagrid-footer");
...
var p=$(e.target).closest("div.datagrid-view,div.combo-easypanel");
if(p.length){
return;
}
_88d(_88c);
...
var body=$(_922).datagrid("geteasypanel").find("div.datagrid-body");
...
if(opts.lines){
t.treegrid("geteasypanel").addClass("tree-lines");
}else{
t.treegrid("geteasypanel").removeClass("tree-lines");
return;
}
t.treegrid("geteasypanel").find("span.tree-indent").removeClass("tree-line tree-join tree-joinbottom");
t.treegrid("geteasypanel").find("div.datagrid-cell").removeClass("tree-node-last tree-root-first tree-root-one");
...
$("body>div.combo-p>div.combo-easypanel:visible").easypanel("close");
});
});
function _9ed(_9ee){
...
if(!_9ef.easypanel){
_9ef.easypanel=$("<div class=\"combo-easypanel\"></div>").appendTo("body");
_9ef.easypanel.easypanel({minWidth:opts.easypanelMinWidth,maxWidth:opts.easypanelMaxWidth,minHeight:opts.easypanelMinHeight,maxHeight:opts.easypanelMaxHeight,doSize:false,closed:true,cls:"combo-p",style:{position:"absolute",zIndex:10},onOpen:function(){
var _9f0=$(this).easypanel("options").comboTarget;
var _9f1=$.data(_9f0,"combo");
if(_9f1){
_9f1.options.onShoweasypanel.call(_9f0);
}
},onBeforeClose:function(){
_9ec($(this).parent());
},onClose:function(){
var _9f2=$(this).easypanel("options").comboTarget;
var _9f3=$(_9f2).data("combo");
if(_9f3){
_9f3.options.onHideeasypanel.call(_9f2);
}
}});
}
...
function _9f8(_9f9){
var _9fa=$.data(_9f9,"combo").easypanel;
if(_9fa.is(":visible")){
var _9fb=_9fa.combo("combo");
_9fc(_9fb);
if(_9fb!=_9f9){
$(_9f9).combo("showeasypanel");
}
}else{
var p=$(_9f9).closest("div.combo-p").children(".combo-easypanel");
$("div.combo-easypanel:visible").not(_9fa).not(p).easypanel("close");
$(_9f9).combo("showeasypanel");
}
...
var p=$(_9ff).closest("div.combo-p").children(".combo-easypanel");
$("div.combo-easypanel:visible").not(p).each(function(){
...
_a04.easypanel.easypanel("options").comboTarget=_a03;
switch(e.keyCode){
case 38:
...
var _a08=_a07.combo;
var _a09=_a07.easypanel;
var opts=$(_a06).combo("options");
var _a0a=_a09.easypanel("options");
_a0a.comboTarget=_a06;
if(_a0a.closed){
_a09.easypanel("easypanel").show().css({zIndex:($.fn.menu?$.fn.menu.defaults.zIndex++:($.fn.window?$.fn.window.defaults.zIndex++:99)),left:-999999});
_a09.easypanel("resize",{width:(opts.easypanelWidth?opts.easypanelWidth:_a08._outerWidth()),height:opts.easypanelHeight});
_a09.easypanel("easypanel").hide();
_a09.easypanel("open");
}
(function(){
if(_a0a.comboTarget==_a06&&_a09.is(":visible")){
_a09.easypanel("move",{left:_a0b(),top:_a0c()});
setTimeout(arguments.callee,200);
}
})();
function _a0b(){
var left=_a08.offset().left;
if(opts.easypanelAlign=="right"){
...
function _9fc(_a0d){
var _a0e=$.data(_a0d,"combo").easypanel;
_a0e.easypanel("close");
};
...
$.data(this,"combo",{options:$.extend(true,{cloned:true},$(from).combo("options")),combo:$(this).next(),easypanel:$(from).combo("easypanel")});
$(this).addClass("combo-f").attr("comboName",$(this).attr("textboxName"));
});
},combo:function(jq){
return jq.closest(".combo-easypanel").easypanel("options").comboTarget;
},easypanel:function(jq){
return $.data(jq[0],"combo").easypanel;
},destroy:function(jq){
return jq.each(function(){
_9f5(this);
});
},showeasypanel:function(jq){
return jq.each(function(){
_a05(this);
});
},hideeasypanel:function(jq){
return jq.each(function(){
_9fc(this);
});
},clear:function(jq){
...
var t=$(_a2e);
return $.extend({},$.fn.textbox.parseOptions(_a2e),$.parser.parseOptions(_a2e,["separator","easypanelAlign",{easypanelWidth:"number",hasDownArrow:"boolean",delay:"number",selectOnNavigation:"boolean"},{easypanelMinWidth:"number",easypanelMaxWidth:"number",easypanelMinHeight:"number",easypanelMaxHeight:"number"}]),{easypanelHeight:(t.attr("easypanelHeight")=="auto"?"auto":parseInt(t.attr("easypanelHeight"))||undefined),multiple:(t.attr("multiple")?true:undefined)});
};
$.fn.combo.defaults=$.extend({},$.fn.textbox.defaults,{inputEvents:{click:_9fe,keydown:_a02,paste:_a02,drop:_a02},easypanelWidth:null,easypanelHeight:200,easypanelMinWidth:null,easypanelMaxWidth:null,easypanelMinHeight:null,easypanelMaxHeight:null,easypanelAlign:"left",multiple:false,selectOnNavigation:true,separator:",",hasDownArrow:true,delay:200,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
},query:function(q,e){
}},onShoweasypanel:function(){
},onHideeasypanel:function(){
...
var _a3a=$(_a39).combobox("easypanel");
...
opts.view.render.call(opts.view,_a4e,$(_a4e).combo("easypanel"),_a50.data);
...
$(_a61).combo($.extend({},opts,{onShoweasypanel:function(){
$(this).combo("easypanel").find("div.combobox-item:hidden,div.combobox-group:hidden").show();
_a42(this,$(this).combobox("getValues"),true);
$(this).combobox("scrollTo",$(this).combobox("getValue"));
opts.onShoweasypanel.call(this);
}}));
var p=$(_a61).combo("easypanel");
p.unbind(".combobox");
for(var _a63 in opts.easypanelEvents){
p.bind(_a63+".combobox",{target:_a61},opts.easypanelEvents[_a63]);
}
};
function _a64(e){
...
function _a66(e){
var _a67=$(this).easypanel("options").comboTarget;
if(!_a67){
return;
}
...
$(_a67).combobox("setValue",_a68).combobox("hideeasypanel");
}
e.stopPropagation();
};
function _a69(e){
var _a6a=$(this).easypanel("options").comboTarget;
if(!_a6a){
return;
}
...
}}),easypanelEvents:{mouseover:_a64,mouseout:_a65,click:_a66,scroll:_a69},filter:function(q,row){
var opts=$(this).combobox("options");
...
$(_a9a).combo($.extend({},opts,{onShoweasypanel:function(){
if(opts.editable){
tree.tree("doFilter","");
}
opts.onShoweasypanel.call(this);
}}));
var _a9c=$(_a9a).combo("easypanel");
if(!tree){
...
var grid=_ac0.grid;
$(_abf).addClass("combogrid-f").combo($.extend({},opts,{onShoweasypanel:function(){
_ad5(this,$(this).combogrid("getValues"),true);
var p=$(this).combogrid("easypanel");
var _ac1=p.outerHeight()-p.height();
var _ac2=p._size("minHeight");
var _ac3=p._size("maxHeight");
var dg=$(this).combogrid("grid");
dg.datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.easypanelHeight))?"auto":"100%"),minHeight:(_ac2?_ac2-_ac1:""),maxHeight:(_ac3?_ac3-_ac1:"")});
...
function _ac8(dg){
return $(dg).closest(".combo-easypanel").easypanel("options").comboTarget||_abf;
};
function _ac5(data){
var _ac9=_ac8(this);
...
return jq.each(function(){
$(this).combo("cloneFrom",from);
$.data(this,"combogrid",{options:$.extend(true,{cloned:true},$(from).combogrid("options")),combo:$(this).next(),easypanel:$(from).combo("easypanel"),grid:$(from).combogrid("grid")});
});
},grid:function(jq){
...
$(_afc).addClass("combotreegrid-f").combo($.extend({},opts,{onShoweasypanel:function(){
var p=$(this).combotreegrid("easypanel");
var _afe=p.outerHeight()-p.height();
var _aff=p._size("minHeight");
var _b00=p._size("maxHeight");
var dg=$(this).combotreegrid("grid");
dg.treegrid("resize",{width:"100%",height:(isNaN(parseInt(opts.easypanelHeight))?"auto":"100%"),minHeight:(_aff?_aff-_afe:""),maxHeight:(_b00?_b00-_afe:"")});
...
$(_b20).addClass("datebox-f").combo($.extend({},opts,{onShoweasypanel:function(){
_b22(this);
_b23(this);
_b24(this);
...
if(!_b21.calendar){
var _b25=$(_b20).combo("easypanel").css("overflow","hidden");
_b25.easypanel("options").onBeforeDestroy=function(){
...
$.fn.datebox.defaults=$.extend({},$.fn.combo.defaults,{easypanelWidth:180,easypanelHeight:"auto",sharedCalendar:null,keyHandler:{up:function(e){
},down:function(e){
},left:function(e){
},right:function(e){
},enter:function(e){
...
$(this).closest("div.combo-easypanel").easypanel("close");
}}],formatter:function(date){
...
$(_b4a).datebox($.extend({},opts,{onShoweasypanel:function(){
...
if(!_b4b.spinner){
var _b4d=$(_b4a).datebox("easypanel");
...
$(_b65).datetimebox("hideeasypanel");
}},{text:function(_b66){
...
$(_b69).datetimebox("hideeasypanel");
}}],formatter:function(date){
var h=date.getHours();
